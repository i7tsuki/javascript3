...
document.getElementById('radio-all').addEventListener('change', function() {
	switchDisplay();
});

document.getElementById('radio-working').addEventListener('change', function() {
	switchDisplay();
});

document.getElementById('radio-end').addEventListener('change', function() {
	switchDisplay();
});